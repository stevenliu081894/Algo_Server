    ...
    public class TLCDietTable : DietTable
    {
        ...
        public class ComplexDiseaseDietTable : DietTable
        {
            public ComplexDiseaseDietTable(string sex)
            {
                ...
                specialHealthSuggestion = "減少富含飽和脂肪酸的食物,例如動物性油脂、皮、肥\n肉、加工食品(貢丸、香腸、魚腳、燕餃)、全脂類乳\n製品、棕櫚油、椰子油、碎肉、濃湯等\n2 減少反式脂肪食物,例如奶油、糕餅、西點、瑪琪琳、\n烤酥油等\n 進食時間宜定時定量\n 烹調方式多以清蒸、水煮、涼拌、燒、烤、燉、滷等方式 \n 多攝取富含膳食纖纖維食物,如蔬菜、水果、全穀類(燕麥、薏仁、糙米等)、未加工的豆類(黃豆、綠豆、紅豆)等\n 有高血壓患者應減少含鈉調味料使用,如醃製類產品、罐頭、調味較重等加工品, 避免飲酒,適量運動";
            }
        }
        ...
        public class HighBloodSugarDietTable : DietTable
        {
            public HighBloodSugarDietTable(string sex)
            {
                ...
                specialHealthSuggestion = "- 搭配低鈉 2000mg\n  -減少食用湯汁 \n - 避免醃製類食物,盡量選擇蒸、煮、滷、燉、烤等食物\n - 減少烘焙類食品\n - 紅肉取代白肉\n - 減少甜食、含糖飲量的攝取\n - 蛋白質盡量選擇低脂肉類(魚類、海鮮、家禽等)\n - 乳品類選擇低脂或者是脫脂類";
            }
        }
        ...
        public class Type2KidneyDiseaseDietTable : DietTable
        {
            public Type2KidneyDiseaseDietTable(string sex)
            {
                ...
                specialHealthSuggestion = "比照第一型腎臟病\n - 低氮澱粉選擇:冬粉、藕粉、西谷米、米苔目、蒟蒻、低\n 蛋白米、肉圓(外皮)、水晶餃(外皮)、腸粉(外\n皮)、蚵仔煎(不包含蛋及牡蠣)";
            }
        }
        ...
        public class SarcopeniaDietTable : DietTable
        {
            public SarcopeniaDietTable(string sex)
            {
                ...
                specialHealthSuggestion = "肌少症的長輩,若有食慾不佳的情況出現時,建議先將豆\n魚蛋肉類吃完之後,再吃";
            }
        }
    }
}
