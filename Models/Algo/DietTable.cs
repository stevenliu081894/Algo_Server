...
namespace AlgoServer.Models.Algo
{
    ...
    public class NormalDietTable : DietTable
    {
        public NormalDietTable(string gender)
        {
            ...
            specialHealthSuggestion = "全穀雜糧類 每天三餐中，至少要有 1/3 選用「未經精製」的全穀雜糧類 當作主食的來源，如糙米、胚芽米、紫米、全麥、蕃薯、馬 鈴薯、芋頭、南瓜、山藥、蓮藕、薏仁、藜麥、小米、紅 豆、綠豆、花豆、蠶豆、皇帝豆、栗子、蓮子、菱角等。 \n 乳品類 u 乳品類包括鮮乳、低脂乳、脫脂乳、保久乳、奶粉、優酪 乳、優格、乳酪、冰淇淋等。和其他食物一起進食時喝牛奶 可以幫助減少乳糖不耐的症狀。規律由少漸增食用含乳糖的 食物（ 如：每天少量喝牛奶，持續 2 - 3 星期 ）也可幫助 身體適應乳糖而減少乳糖耐受不良的症狀。 \n 蔬菜類 : 蔬菜的維生素、礦物質、膳食纖維，以及植化素含量很豐 富。蔬菜的顏色越深綠或深黃，含有的維生素 A、C 及礦物 質鐵、鈣也越多。 Ø 豆魚蛋肉類\n\nu\n\n35 u 豆魚蛋肉類食物是蛋白質的重要來源，應該盡量選擇植物\n\n性、脂肪含量較低的，並避免油炸和過度加工的食品。魚 類食物（ 包括各種魚、蝦、貝類、甲殼類、頭足類等水產 食物 ）含有豐富的動物性蛋白質，其 PUFA(polyunsaturated fatty acids)多於動物性蛋白質。可 以連骨頭一起食用的魚類含有豐富的鈣質，如小魚干、吻 仔魚、櫻花蝦等。 黃豆及黃豆製品提供豐富植物性蛋白質，雖然缺乏甲硫胺 酸（ 人體的必需胺基酸之一 ），但同時與其他植物性食 物混合食用，就可以達到互補的效果，例如豆類和穀類、 豆類和堅果種子類等一起食用。 肉類食品包括家禽和家畜的肉、內臟及其製品，是飲食中 重要的蛋白質來源，但是肉類食品中也含有較多的飽和脂 肪，對心血管的健康較不利，宜適量選用較瘦的肉。肉類 含有多種礦物質，顏色越紅的肉中鐵質含量越多。 u 蛋類主要指各種家禽的蛋，含有豐富的蛋白質，而且是所 有食物中蛋白質品質最佳的。除了蛋白質，蛋類也含有脂 肪，集中在蛋黃的部份；也含有豐富的維生素 A、維生素 B1、B2 和鐵、磷等礦物質。\n\nu\n\nu\n\n36 u 食物優先順序應為豆類>魚類與海鮮>蛋類>禽肉、畜肉，\n\n且應避免加工肉品。\n\nØ 水果類\n\nu 水果含豐富的維生素、植化素及膳食纖維，其內部的水溶 性膳食纖維，可協助糞便軟化、提供益菌質幫助腸道好菌 增生。 Ø 油脂與堅果種子類 u 日常飲食所使用的食用油應該以含單元不飽和脂肪酸為 主，如橄欖油、苦茶油、芥花油、油菜籽油、花生油等植 物油，少用大豆油、玉米油、葵花油 u 每天至少攝取一份堅果種子類， 例如花生、瓜子、葵瓜 子、芝麻、腰果、杏仁、核桃等，不僅含有 MUFA，亦包 含維生素Ｅ及礦物質等營養素 u 若長輩牙口不好，可選擇粉類製品，或購買後自行磨碎";
        }
    }
    ...
    public class TLCDietTable : DietTable
    {
        public TLCDietTable(string sex)
        {
            ...
            specialHealthSuggestion = "豆魚蛋肉類選擇低脂食物，宜選用去皮的雞肉、魚肉、瘦 肉、蛋白、脫脂或低脂奶，且動物性蛋白質每日不超過 2 份\n\n45 Ø\n\n可多選擇燕麥、米糠、小麥胚芽、糙米、豆類、蘋果、洋 車前子、藍莓、大麥、豌豆、扁豆、杏仁、核桃、葵花 籽、南瓜籽高麗菜等食物，富含較多植物固醇及可溶性纖維";
        }
